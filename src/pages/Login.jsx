...
const Login = () => {
  ...
  return (
    <div className="w-full h-screen flex">
      <div className="flex w-1/2 py-52 z-50">
        <div className="w-[450px] h-[450px] mx-auto text-black">
      ...
      <div className="w-1/2">
        <img
          className="flex absolute h-full w-1/2 object-cover"
          src={bgImage}
          alt="/"
        />
      </div>
